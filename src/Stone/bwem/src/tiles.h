...
// The whole process of analysis of a Map rely on the walkability information
...
public:
	...
	// The intention is not to break the continuity of altitudes inside Areas.
...
////////////////////////////////////////////////////////////////////////////
//	Details: The functions below are used by the BWEM's initialization and update process
...
// As a consequence, Tiles should be prefered over MiniTiles, for efficiency.
// The use of Tiles is further facilitated by some redundant functions like Tile::AreaId or Tile::MinAltitude.
//
...
public:
	...
	// Tile::AreaId() somewhat sums up the MiniTile::AreaId() values of the 4 x 4 sub-MiniTiles
	...
	// Tile::MinAltitude() somewhat sums up the MiniTile::Altitude() values of the 4 x 4 sub-MiniTiles
	...
	// Corresponds to BWAPI::isHigherGround
	bool				HigherGround() const			{ return m_bits.higherGround; }
...
//	Details: The functions below are used by the BWEM's initialization and update process
	...
	void				SetHigherGround()				{ m_bits.higherGround = 1; }
...
private:
	struct Bits
	{
						Bits() : buildable(0), higherGround(0) {}
		uint8_t			buildable:1;
		uint8_t			higherGround:1;
	};
