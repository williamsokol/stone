...
// Areas aim at capturing relevant regions that can be walked, though they may contain small inner regions called lakes.
// More formally:
...
public:
	...
	// Returns whether this Area is accessible from pArea.
	...
	// Note: only a call to Map::OnMineralDestroyed(BWAPI::Unit u) may change the result.
