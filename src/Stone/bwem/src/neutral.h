...
public:
	...
	// with the exception of stacked blocking Neutral for which only one pseudo ChokePoint is created.
	// Cf. definition of pseudo ChokePoints in class ChokePoints comment
