...
{
public:
	// ChokePoint::middle denotes the "middle" MiniTile of this ChokePoint, while
	...
	// If IsPseudo(), returns {p} where p is a the position of a walkable MiniTile near from BlockingNeutral()->Pos().
	...
	//       As a consequence, the returned may not be the shortest one.
