...
// A Base is essentially a proposed location (intended to be optimal) to put a Command Center, Nexus, or Hatchery.
// It also provides information on the ressources available.
...
public:
	...
	// Note: The size of the returned list is may decrease, as some of the Minerals may get destroyed.
	...
	// Note: The size of the returned list is may NOT decrease, as Geysers never get destroyed.
	...
	// effectively blocking the building of a Command Center, Nexus, or Hatchery.
